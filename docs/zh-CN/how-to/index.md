...
操作指南聚焦于你在 Yomika 中最常需要完成的具体任务。

## 常见任务

- [安装 Yomika](install-yomika.md)：发行版安装、首次启动下载与加速说明
- [运行时与模型下载](runtime-and-model-downloads.md)：说明 Yomika 会下载什么、缓存到哪里，以及在报 bug 前如何先做连接自检
