...
Yomika に興味を持っていただきありがとうございます。Yomika は Rust バックエンドと Tauri / Next.js UI を組み合わせた、ローカルファーストの ML マンガ翻訳ツールです。あなたの協力を歓迎します。
...
- **低品質または未確認の投稿は直ちにクローズされる場合があります。** 投稿するすべての変更を理解し、検証する責任はコントリビューターにあります。
