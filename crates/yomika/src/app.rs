//! Binary entry point. Wires `yomika-app::App` to the axum router plus
//! (optionally) Tauri.
...
use yomika_app::{App, AppConfig, config as app_config};
...
async fn bootstrap_app(
    ...
    yomika_llm::suppress_native_logs();
