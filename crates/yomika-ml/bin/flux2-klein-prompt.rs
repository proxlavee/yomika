...
use clap::Parser;
use yomika_ml::flux2_klein::qwen::{PromptEmbedder, QwenTextEncoder};
...
struct Cli {
    ...
    #[arg(
        ...
        long,
        value_name = "FILE",
        default_value = "yomika-ml/src/flux2_klein/prompt.safetensors"
    )]
    output: PathBuf,
...
async fn main() -> Result<()> {
    ...
    let device = yomika_ml::device(false)?;
