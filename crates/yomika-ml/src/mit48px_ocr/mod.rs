...
yomika_runtime::declare_hf_model_package!(id: "model:mit48px-ocr:config", repo: HF_REPO, file: "config.json", bootstrap: false, order: 210);
yomika_runtime::declare_hf_model_package!(id: "model:mit48px-ocr:dictionary", repo: HF_REPO, file: "alphabet-all-v7.txt", bootstrap: false, order: 211);
yomika_runtime::declare_hf_model_package!(id: "model:mit48px-ocr:weights", repo: HF_REPO, file: "model.safetensors", bootstrap: false, order: 212);
