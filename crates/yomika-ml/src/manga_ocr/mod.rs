...
yomika_runtime::declare_hf_model_package!(id: "model:manga-ocr:config", repo: HF_REPO, file: "config.json", bootstrap: false, order: 200);
yomika_runtime::declare_hf_model_package!(id: "model:manga-ocr:preprocessor", repo: HF_REPO, file: "preprocessor_config.json", bootstrap: false, order: 201);
yomika_runtime::declare_hf_model_package!(id: "model:manga-ocr:vocab", repo: HF_REPO, file: "vocab.txt", bootstrap: false, order: 202);
yomika_runtime::declare_hf_model_package!(id: "model:manga-ocr:special-tokens", repo: HF_REPO, file: "special_tokens_map.json", bootstrap: false, order: 203);
yomika_runtime::declare_hf_model_package!(id: "model:manga-ocr:weights", repo: HF_REPO, file: "model.safetensors", bootstrap: false, order: 204);
