...
use crate::sys::{llama_batch, llama_batch_free, llama_batch_init, llama_pos, llama_seq_id};
...
pub struct LlamaBatch<'a> {
    ...
    /// The llama_cpp batch. always initialize by `crate::sys::llama_batch_init(allocated, <unknown>, <unknown>)`
