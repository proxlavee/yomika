//! This is a translation of simple.cpp in llama.cpp using yomika-llm.
#![allow(
...
use clap::Parser;
use yomika_llm::safe::context::params::LlamaContextParams;
use yomika_llm::safe::llama_backend::LlamaBackend;
use yomika_llm::safe::llama_batch::LlamaBatch;
use yomika_llm::safe::model::AddBos;
use yomika_llm::safe::model::LlamaModel;
use yomika_llm::safe::model::params::kv_overrides::ParamOverrideValue;
use yomika_llm::safe::model::params::{LlamaModelParams, LlamaSplitMode};
use yomika_llm::safe::sampling::LlamaSampler;
use yomika_llm::safe::{LogOptions, ggml_time_us, send_logs_to_tracing};
...
fn main() -> Result<()> {
    ...
    if list_devices {
        let devices = yomika_llm::safe::list_llama_ggml_backend_devices();
