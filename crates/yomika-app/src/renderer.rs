...
fn core_align_to_renderer(a: yomika_core::TextAlign) -> RendererTextAlign {
    match a {
        yomika_core::TextAlign::Left => RendererTextAlign::Left,
        yomika_core::TextAlign::Center => RendererTextAlign::Center,
        yomika_core::TextAlign::Right => RendererTextAlign::Right,
    }
}
