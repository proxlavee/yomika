...
use yomika_secrets::SecretStore;

use crate::pipeline::{Artifact, Registry};

const CONFIG_FILE: &str = "config.toml";
const REDACTED: &str = "[REDACTED]";
const SECRET_SERVICE: &str = "yomika";
...
impl Default for PipelineConfig {
    fn default() -> Self {
        Self {
            ...
            renderer: "yomika-renderer".to_string(),
        }
    }
}
...
pub fn apply_patch(config: &mut AppConfig, patch: yomika_core::ConfigPatch) {
...
mod tests {
    use super::*;
    use yomika_core::{ConfigPatch, PipelineConfigPatch};
    ...
    fn config_path_uses_appdata_layout() {
        ...
        assert!(path.as_str().contains("Yomika"));
    }
