...
use yomika_core::{FontPrediction, NodeDataPatch, NodePatch, Op, TextDataPatch};
use yomika_ml::font_detector::FontDetector;
...
fn ml_prediction_to_core(p: yomika_ml::types::FontPrediction) -> FontPrediction {
    FontPrediction {
        top_fonts: p
            .top_fonts
            .into_iter()
            .map(|tf| yomika_core::TopFont {
                index: tf.index,
                score: tf.score,
            })
            .collect(),
        named_fonts: p
            .named_fonts
            .into_iter()
            .map(|nf| yomika_core::NamedFontPrediction {
                index: nf.index,
                name: nf.name,
...
fn normalize_font_prediction(p: &mut yomika_ml::types::FontPrediction) {
