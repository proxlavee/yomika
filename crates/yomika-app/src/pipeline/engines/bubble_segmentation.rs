...
use yomika_core::{MaskRole, Op};
use yomika_ml::speech_bubble_segmentation::{SpeechBubbleRegion, SpeechBubbleSegmentation};
...
mod tests {
    use super::*;
    use yomika_ml::speech_bubble_segmentation::{SpeechBubbleRegion, SpeechBubbleRegionMask};
