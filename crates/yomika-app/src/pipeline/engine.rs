...
use yomika_core::{NodeId, Op, PageId, ReadingOrder, Region, Scene};
...
pub struct PipelineRunOptions {
    ...
    /// Correlates a UI auto-render with the edit that scheduled it. Pipeline
    /// output is applied only while this remains the current history epoch,
    /// and is merged into that edit's undo entry.
