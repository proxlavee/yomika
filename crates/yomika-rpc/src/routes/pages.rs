...
use yomika_app::pipeline::{self, EngineCtx, PipelineRunOptions};
use yomika_core::{
...
#[allow(dead_code)]
struct CreatePagesMultipartBody {
    /// Image files to import as pages, in upload order.
    file: Vec<BinaryPayload>,
...
#[utoipa::path(
    post,
    path = "/pages",
    request_body(content = inline(CreatePagesMultipartBody), content_type = "multipart/form-data"),
...
#[derive(utoipa::ToSchema)]
#[allow(dead_code)]
struct AddImageLayerMultipartBody {
...
#[utoipa::path(
    ...
    request_body(content = inline(AddImageLayerMultipartBody), content_type = "multipart/form-data"),
...
fn center_on_page(page: Option<&yomika_core::Page>, iw: u32, ih: u32) -> (f32, f32) {
...
#[utoipa::path(
    ...
    request_body(content = inline(BinaryPayload), content_type = "image/png"),
        ...
        match existing {
            ...
            None => {
                ...
                let node = Node {
                    ...
                    kind: NodeKind::Mask(yomika_core::MaskData {
                        role,
                        blob: blob.clone(),
                    }),
                };
...
async fn reorder_text_nodes(
    ...
    let new_order_opt = {
        ...
        // 2. Sort them
        yomika_app::pipeline::support::sort_manga_reading_order(&mut text_nodes, order);
